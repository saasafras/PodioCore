...
namespace PodioCore.Utils
{
    ...
    {
        public static string ArrayToCSV(int[] array, string splitter = ",")
        {
        ...
        /// <returns></returns>
        public static string DictionaryToQueryString(Dictionary<string, string> attributes)
        {
        ...
        /// <returns></returns>
        public static string PrepareUrlWithOptions(string url, CreateUpdateOptions options)
        {
